                    ...
                    <div class=" relative px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:bg-white">  
                        {Children.map(props.children, (child) => {
                            if(child.props.className === "timeline-data") {
                                return( <div class="flex pb-2 flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-green-300 lg:before:outline-2 before:outline-0 before:outline before:outline-white lg:pb-auto">
                                ...
                                <p class="mt-1">{child.props.children[2]}</p>
                                </div>
                                )
                            }
                        })}
