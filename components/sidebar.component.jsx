...
export default function Sidebar() {
    ...
    return(
    <>
    <button className="fixed z-50 text-black bottom-0 rounded-md bg-white w-full p-3 lg:hidden" 
    onClick={() => setMenuOpen(!menuOpen)}>
        MENU
    </button>
    <aside className={`z-20 bg-primary-color-full lg:flex absolute lg:relative overflow-x-hidden flex-col lg:w-56 w-full h-screen px-4 py-8 overflow-y-auto ${menuOpen ? "" : "hidden"}`}>
