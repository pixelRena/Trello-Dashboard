export default function SearchBar() {
    return(
        <form className="relative h-fit bg-primary-color rounded-2xl">
            <label className="hidden" htmlFor="searchInput">Search Bar</label>
            <input className="lg:w-[22vw] w-[30vw] font-extralight bg-transparent p-3" type="text" id="searchInput" placeholder="Search tasks ..."/>
