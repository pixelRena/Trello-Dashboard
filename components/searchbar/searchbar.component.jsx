export default function SearchBar() {
    return(
        <form className="relative h-fit">
            ...
            <input className="w-[30vw] font-extralight bg-white/[.80] border-0 ring-0 outline-0 backdrop-blur-2xl rounded-2xl p-3 text-black focus:bg-white lg:w-[22vw] hover:bg-white focus:ring-0 focus:outline-0 focus:border-0" type="text" id="searchInput" placeholder="Search tasks ..."/>
