export default function SearchBar() {
    return(
        <form className="relative h-fit">
            ...
            <input className="w-[30vw] font-extralight bg-white/[.80] backdrop-blur-2xl rounded-2xl p-3 text-black focus:bg-white lg:w-[22vw] hover:bg-white" type="text" id="searchInput" placeholder="Search tasks ..."/>
