...
export default function UserDropdown() {
    ...
    return(
        <div className="relative">
            <button className={`relative ${isUserOpen ? "" : "bg-primary-color"} z-[16] rounded-2xl lg:p-2 p-3 w-full`} type="button" onClick={() => setIsUserOpen(!isUserOpen)}>
                ...
                <div className="inline">
                    <span className="">Serena Dean</span>
